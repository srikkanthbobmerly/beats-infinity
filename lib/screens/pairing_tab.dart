...
class PairingTabBody extends StatelessWidget {
  const PairingTabBody({super.key});
    ...
    if (myPairs.isEmpty) {
      return const Center(
        child: Column(
          ...
          children: [
            Icon(Icons.favorite_border_rounded, color: AppColors.textMuted, size: 40),
            SizedBox(height: 10),
      ...
      children: [
        const Row(
          children: [
            ...
            SizedBox(width: 8),
            Text('My Pairings', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
          ],
        ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Expanded(child: Text(partner, style: const TextStyle(color: AppColors.accent, fontWeight: FontWeight.w600))),
                  ],
                ),
                ...
                Row(
                  children: [
                    ...
                    Expanded(child: Text(p.songTitle, style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold))),
                  ],
                ),
